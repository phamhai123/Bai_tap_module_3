  ...
  <div class="container">
    ...
    <form method="post">
      ...
      <div class="my-3">
        ...
        <input type="text"
               class="form-control" name="birthday" id="birthday" aria-describedby="helpId" placeholder="" value="${user.birthday}">
      </div>
      <div class="my-3">
      ...
      <div class="my-3">
        ...
        <input type="text"
               class="form-control" name="address" id="address" aria-describedby="helpId" placeholder="" value="${user.address}">
      </div>
